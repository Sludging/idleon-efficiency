...
const ColorSection = ({ upgrades, essence} : { upgrades: SummonUpgrade[], essence: SummonEssence } ) => {
    return (
                ...
                <Box direction="column" margin={{ top: 'small' }}>
                    {
                        ...
                        .map((essence, index) => (
                            <ColorSection key={index} upgrades={upgradesToDisplay.filter(upgrade => upgrade.data.colour == essence.color)} essence={essence} />
                        ))
                    }
                </Box>
            </Box>
