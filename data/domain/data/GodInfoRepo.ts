...
export const initGodInfoRepo = () => {
    return [    
        new GodInfoBase(0, <GodInfoModel>{
                ...
                "blessingBonus": "+{% Divinity PTS Gain",
        ...
        new GodInfoBase(2, <GodInfoModel>{
                ...
                "blessingBonus": "+{ All Skill Efficiency",
        ...
        new GodInfoBase(8, <GodInfoModel>{
                "name": "Kattlekruk",
                "majorBonus": "Every day you play, you get +$ LV for these Alchemy Bubbles: @ # @   @ Only 1 player can link here.",
                "passiveBonus": "+{% chance for 2x Statue Drops, for ALL characters!",
                "passiveMax": 10,
                "blessingBaseCost": 1000000000,
                "blessingIncrement": 3,
                "blessingBonus": "+{% Total Damage",
