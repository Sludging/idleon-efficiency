...
export const initMapPortalsRepo = () => {
    return [    
        ...
        new MapInfoBase(2, <MapInfoModel>{"id": 2, "portalRequirements": [25], "maxOnScreen": 34}),
        ...
        new MapInfoBase(14, <MapInfoModel>{"id": 14, "portalRequirements": [50, 2000], "maxOnScreen": 22}),
        ...
        new MapInfoBase(19, <MapInfoModel>{"id": 19, "portalRequirements": [90], "maxOnScreen": 17}),
        ...
        new MapInfoBase(24, <MapInfoModel>{"id": 24, "portalRequirements": [120, 2000], "maxOnScreen": 16}),
        new MapInfoBase(25, <MapInfoModel>{"id": 25, "portalRequirements": [0], "maxOnScreen": 0}),
        new MapInfoBase(26, <MapInfoModel>{"id": 26, "portalRequirements": [130], "maxOnScreen": 21}),
        ...
        new MapInfoBase(43, <MapInfoModel>{"id": 43, "portalRequirements": [0], "maxOnScreen": 15}),
        ...
        new MapInfoBase(51, <MapInfoModel>{"id": 51, "portalRequirements": [100], "maxOnScreen": 17}),
        new MapInfoBase(52, <MapInfoModel>{"id": 52, "portalRequirements": [120, 1000], "maxOnScreen": 21}),
        new MapInfoBase(53, <MapInfoModel>{"id": 53, "portalRequirements": [150], "maxOnScreen": 18}),
        ...
        new MapInfoBase(57, <MapInfoModel>{"id": 57, "portalRequirements": [200], "maxOnScreen": 15}),
        new MapInfoBase(58, <MapInfoModel>{"id": 58, "portalRequirements": [250], "maxOnScreen": 18}),
        new MapInfoBase(59, <MapInfoModel>{"id": 59, "portalRequirements": [300], "maxOnScreen": 14}),
        new MapInfoBase(60, <MapInfoModel>{"id": 60, "portalRequirements": [500, 0], "maxOnScreen": 17}),
        new MapInfoBase(61, <MapInfoModel>{"id": 61, "portalRequirements": [30], "maxOnScreen": 3}),
        new MapInfoBase(62, <MapInfoModel>{"id": 62, "portalRequirements": [1000], "maxOnScreen": 17}),
        new MapInfoBase(63, <MapInfoModel>{"id": 63, "portalRequirements": [2000], "maxOnScreen": 15}),
        new MapInfoBase(64, <MapInfoModel>{"id": 64, "portalRequirements": [3000], "maxOnScreen": 27}),
        ...
        new MapInfoBase(298, <MapInfoModel>{"id": 298, "portalRequirements": [0], "maxOnScreen": 0}),
        new MapInfoBase(299, <MapInfoModel>{"id": 299, "portalRequirements": [0], "maxOnScreen": 0}),
        new MapInfoBase(300, <MapInfoModel>{"id": 300, "portalRequirements": [1, 0], "maxOnScreen": 0}),
        new MapInfoBase(301, <MapInfoModel>{"id": 301, "portalRequirements": [100000], "maxOnScreen": 16}),
        new MapInfoBase(302, <MapInfoModel>{"id": 302, "portalRequirements": [250000], "maxOnScreen": 19}),
        new MapInfoBase(303, <MapInfoModel>{"id": 303, "portalRequirements": [10000000, 1500000], "maxOnScreen": 19}),
        new MapInfoBase(304, <MapInfoModel>{"id": 304, "portalRequirements": [5000000], "maxOnScreen": 15}),
        new MapInfoBase(305, <MapInfoModel>{"id": 305, "portalRequirements": [20000000, 1000000], "maxOnScreen": 29}),
        new MapInfoBase(306, <MapInfoModel>{"id": 306, "portalRequirements": [0], "maxOnScreen": 25}),
        new MapInfoBase(307, <MapInfoModel>{"id": 307, "portalRequirements": [250000000, 20000000], "maxOnScreen": 20}),
        new MapInfoBase(308, <MapInfoModel>{"id": 308, "portalRequirements": [60000000], "maxOnScreen": 19}),
        new MapInfoBase(309, <MapInfoModel>{"id": 309, "portalRequirements": [0], "maxOnScreen": 16}),
        new MapInfoBase(310, <MapInfoModel>{"id": 310, "portalRequirements": [500000000, 75000000], "maxOnScreen": 25}),
