...
export const initMapPortalsRepo = () => {
    return [    
        ...
        new MapInfoBase(14, <MapInfoModel>{"id": 14, "portalRequirements": [120, 2000], "maxOnScreen": 22}),
        new MapInfoBase(15, <MapInfoModel>{"id": 15, "portalRequirements": [35000], "maxOnScreen": 25}),
        new MapInfoBase(16, <MapInfoModel>{"id": 16, "portalRequirements": [120, 3000], "maxOnScreen": 25}),
        ...
        new MapInfoBase(19, <MapInfoModel>{"id": 19, "portalRequirements": [130], "maxOnScreen": 17}),
        ...
        new MapInfoBase(24, <MapInfoModel>{"id": 24, "portalRequirements": [130, 2000], "maxOnScreen": 16}),
