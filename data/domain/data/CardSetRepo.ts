...
export const initCardSetRepo = () => {
    return [    
        ...
        new CardSetBase(9, <CardSetModel>{"bonus": "{% Class Exp (Multi)", "scaling": 10, "image": "CardSet10.png"}),
        new CardSetBase(10, <CardSetModel>{"bonus": "{% more Dungeon Credits", "scaling": 5, "image": "CardSet7.png"}),
        new CardSetBase(11, <CardSetModel>{"bonus": "{% Dmg, Drop, and EXP", "scaling": 6, "image": "CardSet26.png"}),
        new CardSetBase(12, <CardSetModel>{"bonus": "{% Drop Rate", "scaling": 7, "image": "CardSet25.png"}),
        new CardSetBase(13, <CardSetModel>{"bonus": "", "scaling": 7, "image": "Blank.png"}),
        new CardSetBase(14, <CardSetModel>{"bonus": "", "scaling": 7, "image": "Blank.png"})    
]
}
