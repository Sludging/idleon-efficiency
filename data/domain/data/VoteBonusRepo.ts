...
export const initVoteBonusRepo = () => {
    return [    
        ...
        new VoteBonusBase(19, <VoteBonusModel>{"text": "Boosts Shrine EXP gain by a staggering }x", "bonus": 53, "value": 3}),
        new VoteBonusBase(20, <VoteBonusModel>{"text": "Boosts Artifact Find chance in Sailing by }x", "bonus": 31, "value": 5}),
        ...
        new VoteBonusBase(26, <VoteBonusModel>{"text": "Boosts bonuses from all Golden Food by +{%", "bonus": 30, "value": 0}),
        ...
        new VoteBonusBase(31, <VoteBonusModel>{"text": "Increases Lab EXP gain by +{%", "bonus": 90, "value": 4}),
        new VoteBonusBase(32, <VoteBonusModel>{"text": "Boosts Equinox Bar Fill rate by }x", "bonus": 40, "value": 3}),
        new VoteBonusBase(33, <VoteBonusModel>{"text": "Boosts Refinery Cycle Speed by +{%", "bonus": 50, "value": 3}),
        new VoteBonusBase(34, <VoteBonusModel>{"text": "Increases cash earned from monsters by +{%", "bonus": 52, "value": 0})    
]
}
