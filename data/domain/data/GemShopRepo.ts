...
export const initGemShopRepo = () => {
    return [    
        ...
        new GemShopItemBase(88, <GemShopItemModel>{
                ...
                "mtxName": "2 Hour Lantern",
                "itemDisplayName": "Blinding Lantern",
                "desc": "Gives you a Lantern usable item, use it to instantly get 2 hours of ALL cavern progress!! (Except for skilling caverns, like Motherlode)",
                "cost": 1,
                "no": 87,
                "maxPurchases": 6,
                "qty": 1,
        ...
        new GemShopItemBase(89, <GemShopItemModel>{
                ...
                "mtxName": "2 Hour Lantern",
                "itemDisplayName": "Blinding Lantern",
                "desc": "65% off normal price from the Oddities section! Remember, you can only use 12 of these per day while new caverns are released!",
                "cost": 56,
                "no": 88,
                "maxPurchases": 40,
                "qty": 1,
