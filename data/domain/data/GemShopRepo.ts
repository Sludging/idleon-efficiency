...
export const initGemShopRepo = () => {
    return [    
        ...
        new GemShopItemBase(89, <GemShopItemModel>{
                ...
                "name": "Quest96",
                "mtxName": "Aethermoons",
                "itemDisplayName": "Aethermoon",
                "desc": "Gives you an Aethermoon, which gives 2 hours of Windwalker Dust when used! These restock every day.",
                "cost": 160,
                "no": 88,
                "maxPurchases": 12,
                "qty": 1,
        ...
        new GemShopItemBase(91, <GemShopItemModel>{
                "section": "Limited Specials",
                "name": "EquipmentRings34",
                "mtxName": "World 5 Kill Ring",
                "itemDisplayName": "Magma Killer Ring",
                "desc": "All kills in World 5 count for 1.30x for opening portals to the next map. Helps you get to World 6 faster! 30% Faster to be exact!",
                "cost": 750,
                "no": 90,
                "maxPurchases": 2,
                "qty": 1,
        ...
        new GemShopItemBase(92, <GemShopItemModel>{
                ...
                "mtxName": "World 4 Kill Ring",
                "itemDisplayName": "Nebula Killer Ring",
        ...
        new GemShopItemBase(94, <GemShopItemModel>{
                ...
                "desc": "25% OFF NORMAL PRICE!! These unique Time Candies give up to 500 HOURS of AFK time! Click the item in game to see the chances...",
                "cost": 295,
                "no": 93,
                "maxPurchases": 20,
                "qty": 1,
        ...
        new GemShopItemBase(95, <GemShopItemModel>{
                ...
                "mtxName": "Freebie",
                "itemDisplayName": "Aethermoon",
                "desc": "Did you really think I wouldn't have a freebie here for you? Remember, the new Windwalker class comes from the Beastmaster class, so go to Masterius in world 6 on your Beastmaster!",
                "cost": 1,
                "no": 94,
                "maxPurchases": 2,
                "qty": 1,
