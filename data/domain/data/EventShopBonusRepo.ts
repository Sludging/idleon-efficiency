...
export const initEventShopBonusRepo = () => {
    return [    
        ...
        new EventShopBonusBase(28, <EventShopBonusModel>{"name": "Higgs Boson", "desc": "All atoms have a +20 higher Max LV", "price": 150}),
        ...
        new EventShopBonusBase(33, <EventShopBonusModel>{
                "name": "Kaleidoscope",
                "desc": "Gives you 1 more Kaleidoscope for Research in World 7",
                "price": 35
            }),
        new EventShopBonusBase(34, <EventShopBonusModel>{
                "name": "Magnifying Glass",
                "desc": "Gives you 1 more Magnifier for Research in World 7",
                "price": 25
            }),
        new EventShopBonusBase(35, <EventShopBonusModel>{
                "name": "Keen Observations",
                "desc": "Get +3 more Daily Attempts at finding Observations!",
                "price": 33
            }),
        new EventShopBonusBase(36, <EventShopBonusModel>{
                "name": "Shape Obsession",
                "desc": "Get +1 more Shape for your Research Grid in World 7",
                "price": 200
            }),
        new EventShopBonusBase(37, <EventShopBonusModel>{
                "name": "Rift Guy Sticker",
                "desc": "Increases all Sticker Bonuses by +30%",
                "price": 75
            }),
        new EventShopBonusBase(38, <EventShopBonusModel>{
                "name": "Glimbo Coupon",
                "desc": "Lowers the cost of all Glimbo Trades in World 7 by 25%",
                "price": 60
            }),
        new EventShopBonusBase(39, <EventShopBonusModel>{
                "name": "Tiny Cog Twins",
                "desc": "Daily producion of Tiny Cogs is now double!",
                "price": 175
            }),
        new EventShopBonusBase(40, <EventShopBonusModel>{
                "name": "Glimbo VIP Pass",
                "desc": "Each Glimbo Trade boosts Vault Max LV by +2 not +1",
                "price": 199
            }),
        ...
        new EventShopBonusBase(43, <EventShopBonusModel>{
