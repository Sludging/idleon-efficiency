...
export const initActiveTalentRepo = () => {
    return [    
        ...
        new ActiveTalentBase(89, <ActiveTalentModel>{
        ...
        new ActiveTalentBase(90, <ActiveTalentModel>{
        ...
        new ActiveTalentBase(91, <ActiveTalentModel>{
        ...
        new ActiveTalentBase(92, <ActiveTalentModel>{
                "name": "From Downtown",
                "K": 1,
                "D": 1.3,
                "s": 1,
