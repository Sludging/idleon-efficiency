...
export class GoogleDeviceLogin {
    static getCode = async (): Promise<CodeReqResponse> => {
        ...
        var codeReqRespone = await getCodeRes.json();
        return codeReqRespone;
    }

    static pollForAuth = async (deviceCode: string): Promise<PollAuthResponse | undefined> => {
        var getDeviceResult = `client_id=267901585099-u6fjd75v6k9gefq7bcokcndv99riir5j&client_secret=HzoZF-UKUNfFwBuz4vafwsaR&device_code=${deviceCode}&grant_type=urn%3Aietf%3Aparams%3Aoauth%3Agrant-type%3Adevice_code`
