...
const initPurchases = () => {
    return [
        ...
        new GemPurchase(JSON.parse('{"name": "GemP15", "itemName": "Weekly Dungeon Boosters", "desc": "Get an additional +3 Dungeon runs every week, FOREVER! I give you 12 per week for free, so buying this once, for example, would get you 15 runs every week!", "cost": 275, "no": 84, "maxPurchases": 11, "qty": 0, "costIncrement": 40}')),
        ...
        new GemPurchase(JSON.parse('{"name": "EquipmentKeychain8", "itemName": "Tier 2 Keychain", "desc": "Gives you 120 keychain fragments, enough to claim a Tier 2 Keychain from the Frog Dungeon Lobby! These keychains randomly give the following bonuses: %DEF, Mining XP, Fishing XP, %DMG, Drop chance, Atk speed, Crit chance, Multikill", "cost": 200, "no": 85, "maxPurchases": 100000, "qty": 0, "costIncrement": 0}')),
        new GemPurchase(JSON.parse('{"name": "EquipmentKeychain17", "itemName": "Tier 3 Keychain", "desc": "Gives you 300 keychain fragments, enough to claim a Tier 3 Keychain from the Frog Dungeon Lobby! These keychains randomly give the following bonuses: %DEF, %Stat, %AFK gain, %DMG, mob respawn, Skilling spd, %All stat", "cost": 340, "no": 83, "maxPurchases": 100000, "qty": 0, "costIncrement": 0}')),
