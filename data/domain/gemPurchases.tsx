...
const initPurchases = () => {
    return [
        ...
        new GemPurchase(JSON.parse('{"itemName": "Kid In A Candy Store", "desc": "Gives a random Time Candy. The chances are: 50% for 2 Hr, 25% for 4 Hr, 18% for 12 Hr, and 7% for 24 Hr.", "cost": 160, "no": 49, "maxPurchases": 4, "qty": 1, "costIncrement": 0}')),
        new GemPurchase(JSON.parse('{"itemName": "Absolute Sugar Maniac", "desc": "Gives a random Time Candy. The chances are: 33% for 4 Hr, 40% for 12 Hr, 22% for 24 Hr, and 4% for 72 Hr.", "cost": 280, "no": 50, "maxPurchases": 4, "qty": 1, "costIncrement": 0}')),
