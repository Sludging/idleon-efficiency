...
const initPurchases = () => {
    return [
        ...
        new GemPurchase(JSON.parse('{"itemName": "Just One, Please", "desc": "Gives you a single 1 Hour Candy. Also, you\'re not a real adventurer in Flapjack\'s eyes. Sorry, just tellin\' ya like it is!", "cost": 40, "no": 47, "maxPurchases": 4, "qty": 1, "costIncrement": 0}')),
        new GemPurchase(JSON.parse('{"itemName": "Baby\'S First Lolly", "desc": "Gives a random Time Candy. The chances are: 34% for 1 Hr, 33% for 2 Hr, and 33% for 4 Hr.", "cost": 80, "no": 48, "maxPurchases": 4, "qty": 1, "costIncrement": 0}')),
        new GemPurchase(JSON.parse('{"itemName": "Kid In A Candy Store", "desc": "Gives a random Time Candy. The chances are: 50% for 2 Hr, 25% for 4 Hr, 18% for 12 Hr, and 7% for 24 Hr.", "cost": 150, "no": 49, "maxPurchases": 4, "qty": 1, "costIncrement": 0}')),
        new GemPurchase(JSON.parse('{"itemName": "Absolute Sugar Maniac", "desc": "Gives a random Time Candy. The chances are: 33% for 4 Hr, 40% for 12 Hr, 22% for 24 Hr, and 4% for 72 Hr.", "cost": 270, "no": 50, "maxPurchases": 4, "qty": 1, "costIncrement": 0}')),
        ...
        new GemPurchase(JSON.parse('{"itemName": "Storage Chest Space", "desc": "Gives +9 extra Storage Chest Slots! Storage Chests are found in each town, and the items you put in are shared by all your players!", "cost": 175, "no": 56, "maxPurchases": 12, "qty": 1, "costIncrement": 25}')),
        ...
        new GemPurchase(JSON.parse('{"itemName": "Eternal Card Pack", "desc": "Blah", "cost": 600, "no": 65, "maxPurchases": 100000, "qty": 1, "costIncrement": 0}')),
        new GemPurchase(JSON.parse('{"itemName": "Galaxy Card Pack", "desc": "Blah", "cost": 650, "no": 69, "maxPurchases": 100000, "qty": 1, "costIncrement": 0}')),
        ...
        new GemPurchase(JSON.parse('{"itemName": "4 Star Cardifier", "desc": "Use this on a 3 star card to upgrade it to 4 stars! You can use it on any 3 star card you have, it\'s up to you! Each purchase allows for one card of your choice to be upgraded.", "cost": 290, "no": 67, "maxPurchases": 100000, "qty": 0, "costIncrement": 0}')),
        ...
        new GemPurchase(JSON.parse('{"itemName": "Royal Egg Cap", "desc": "Boosts the max number of eggs in your breeding nest by +1. ALSO, as an added bonus, you get 1.10x New Pet Breeding Chance for each time you buy this!", "cost": 350, "no": 119, "maxPurchases": 5, "qty": 0, "costIncrement": 50}')),
        new GemPurchase(JSON.parse('{"itemName": "Richelin Kitchen", "desc": "Upgrades 1 kitchen, in order from first to last, to a Richelin Kitchen! These have 3x Meal Cooking Speed, 2x New Recipe Speed, and 40% Cheaper Upgrade Costs!", "cost": 250, "no": 120, "maxPurchases": 10, "qty": 0, "costIncrement": 40}')),
        new GemPurchase(JSON.parse('{"itemName": "Console Chip", "desc": "Gives you a random console chip. There are currently 22 Chips in the game, so you have a 1 in      22 chance of getting any particular chip.      This item restocks each week.", "cost": 385, "no": 121, "maxPurchases": 7, "qty": 0, "costIncrement": 0}')),
        new GemPurchase(JSON.parse('{"itemName": "Mainframe Jewel", "desc": "Gives you a random Jewel that you don\'t already    own. No need to worry about duplicate jewels!    This item restocks each week, unless you own all Jewels, then it wont restock.", "cost": 450, "no": 122, "maxPurchases": 2, "qty": 0, "costIncrement": 0}')),
        new GemPurchase(JSON.parse('{"itemName": "Souped Up Tube", "desc": "Each purchase soups up 2 lab Tubes. Players in souped-up tubes get 2x Lab EXP gain, and +30% Line Width. Keep in mind, players are placed in tubes in chronological order.", "cost": 480, "no": 123, "maxPurchases": 4, "qty": 0, "costIncrement": 65}')),
        new GemPurchase(JSON.parse('{"itemName": "Pet Storage", "desc": "Unlocks 12 pet storage spaces, which is an entire row!", "cost": 325, "no": 124, "maxPurchases": 12, "qty": 0, "costIncrement": 55}')),
        new GemPurchase(JSON.parse('{"itemName": "Fenceyard Space", "desc": "Unlocks 2 Fenceyard slots, which are great for Breedability Pets and Shiny Pets!", "cost": 275, "no": 125, "maxPurchases": 6, "qty": 0, "costIncrement": 45}')),
        new GemPurchase(JSON.parse('{"itemName": "Carton Of Eggs", "desc": "Each purchase gives anywhere from 3 to 12 eggs in your item inventory! Use these eggs in your          inventory to refill your nest with eggs!              This item restocks each day.", "cost": 270, "no": 126, "maxPurchases": 4, "qty": 1, "costIncrement": 0}')),
    ];
}
