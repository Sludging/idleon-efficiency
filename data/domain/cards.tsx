...
const cardsInit = () => {
    return [
        ...
        new Card(143, "Boss3A", "Z8", "Bosses", 1.5, "+{% Cog Build Spd (Passive)", 8, 8),
        new Card(144, "Boss3B", "Z9", "Bosses", 1.5, "+{% Shrine Effects", 5, 5),
        new Card(145, "Boss4A", "Z10", "Bosses", 2, "+{% Kitchen Speed (Passive)", 6, 6),
        new Card(146, "Boss4B", "Z11", "Bosses", 2, "+{% All Skill Efficiency", 10, 10),
        new Card(147, "ghost", "Y0", "Event", 2, "+{% Monster EXP While Active", 3, 3),
        new Card(148, "xmasEvent", "Y1", "Event", 1.5, "+{% Total Drop Rate", 3, 3),
        new Card(149, "xmasEvent2", "Y2", "Event", 1.5, "+{% Money from Monsters", 3, 3),
        new Card(150, "slimeR", "Y3", "Event", 2, "+{% Defence from Equipment", 3, 3),
        new Card(151, "loveEvent", "Y4", "Event", 1.5, "+{% Total HP", 5, 5),
        new Card(152, "loveEvent2", "Y5", "Event", 1.5, "+{% Boost Food Effect", 4, 4),
        new Card(153, "sheepB", "Y6", "Event", 3, "+{% MP regen rate", 3, 3),
        new Card(154, "snakeY", "Y7", "Event", 3, "+{ Base LUK", 3, 3),
        new Card(155, "EasterEvent1", "Y8", "Event", 1.5, "+{% Card Drop Chance", 1, 1),
        new Card(156, "EasterEvent2", "Y9", "Event", 1.5, "+{% Critical Damage", 1, 1),
        new Card(157, "shovelY", "Y13", "Event", 4, "+{ Base Defence", 2, 2),
        new Card(158, "crabcakeB", "Y10", "Event", 4, "+{% Total Drop Rate", 3, 3),
        new Card(159, "SummerEvent1", "Y11", "Event", 8, "+{% Fishing Away Gains", 1, 1),
        new Card(160, "SummerEvent2", "Y12", "Event", 8, "+{% Catching EXP", 4, 4),
        new Card(161, "xmasEvent3", "Y14", "Event", 1, "+{% Defence from Equipment", 3, 3),
    ];
}
