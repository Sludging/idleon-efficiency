...
const cardsInit = () => {
    return [
        ...
        new Card(76, "Starfire", "F16", "Hard Resources", 12, "+{% Mining EXP", 8, 8),
        new Card(77, "SaharanFoal", "D8", "Hard Resources", 10, "+{% Choppin Away Gains", 2.5, 2.5),
        new Card(78, "Tree7", "F2", "Hard Resources", 10, "+{% Choppin Speed", 6, 6),
        new Card(79, "AlienTree", "F13", "Hard Resources", 10, "+{% Total Choppin Efficiency", 8, 8),
        new Card(80, "Tree8", "F12", "Hard Resources", 10, "+{% Choppin Speed", 7, 7),
        new Card(81, "Fish5", "F20", "Hard Resources", 8, "+{% Total Fishing Efficiency", 8, 8),
        new Card(82, "Fish6", "F21", "Hard Resources", 10, "+{% Fishing Speed", 4, 4),
        new Card(83, "Fish7", "F22", "Hard Resources", 10, "+{% Fishing EXP", 10, 10),
        new Card(84, "Fish8", "F23", "Hard Resources", 10, "+{% Fishing Away Gains", 3, 3),
        ...
        new Card(87, "Bug7", "F14", "Hard Resources", 10, "+{% Total Catching Efficiency", 8, 8),
        new Card(88, "Bug8", "F15", "Hard Resources", 10, "+{% Catching Speed", 4, 4),
        new Card(89, "CritterCard4", "F4", "Hard Resources", 4, "+{% Shiny Critter Chance", 5, 5),
        new Card(90, "CritterCard5", "F5", "Hard Resources", 4, "+{% EXP from monsters", 1.25, 1.25),
        new Card(91, "CritterCard6", "F6", "Hard Resources", 5, "+{% Shiny Critter Chance", 6, 6),
        new Card(92, "CritterCard7", "F7", "Hard Resources", 6, "+{% Skill AFK gain rate", 1, 1),
        new Card(93, "CritterCard8", "F17", "Hard Resources", 7, "+{% Trapping Efficiency", 7, 7),
        new Card(94, "CritterCard9", "F18", "Hard Resources", 9, "+{% Trapping EXP", 8, 8),
        new Card(95, "CritterCard10", "F19", "Hard Resources", 12, "+{% Shiny Critter Chance", 8, 8),
        new Card(96, "SoulCard3", "F3", "Hard Resources", 3, "+{ Starting Pts in Worship", 6, 6),
        new Card(97, "SoulCard4", "F10", "Hard Resources", 4, "+{% Max Charge", 7, 7),
        new Card(98, "SoulCard5", "F11", "Hard Resources", 5, "+{% Charge Rate", 5, 5),
        ...
        new Card(118, "frogGG", "X22", "Dungeons", 5, "{% to start with RNG item", 20, 20),
        new Card(119, "frogGR", "X3", "Dungeons", 1.5, "{% to start with RNG item", 15, 15),
        new Card(120, "frogGR2", "X4", "Dungeons", 1.5, "+{% Dungeon Flurbos", 4, 4),
        new Card(121, "frogGR3", "X5", "Dungeons", 1.5, "+{% Dungeon Credits", 5, 5),
        new Card(122, "frogGR4", "X21", "Dungeons", 1, "+{% Dungeon Move Speed", 7, 7),
        new Card(123, "target", "X6", "Dungeons", 2, "+{ Base Dungeon HP", 2, 2),
        new Card(124, "rocky", "X7", "Dungeons", 2, "+{% Dungeon Card Chance", 8, 8),
        new Card(125, "steakR", "X9", "Dungeons", 2, "+{% Dungeon Money", 6, 6),
        new Card(126, "totem", "X16", "Dungeons", 2, "+{% RNG item rarity", 10, 10),
        new Card(127, "cactus", "X8", "Dungeons", 2, "+{% Dungeon Boss Dmg", 3, 3),
        new Card(128, "potatoB", "X10", "Dungeons", 5, "+{% Dungeon MP regen", 5, 5),
        new Card(129, "snakeZ", "X11", "Dungeons", 1.5, "+{% Dungeon Drop Rate", 4, 4),
        new Card(130, "snakeZ2", "X12", "Dungeons", 1.5, "+{% Total Dungeon Dmg", 5, 5),
        new Card(131, "snakeZ3", "X13", "Dungeons", 1.5, "+{% Dungeon Flurbos", 5, 5),
        new Card(132, "iceknight", "X17", "Dungeons", 8, "+{% Dungeon MP regen", 8, 8),
        new Card(133, "iceBossZ", "X18", "Dungeons", 2, "+{% Dungeon Card Chance", 15, 15),
        new Card(134, "iceBossZ2", "X19", "Dungeons", 1.5, "+{% Dungeon Credits", 8, 8),
        new Card(135, "iceBossZ3", "X20", "Dungeons", 1.5, "+{% Total Dungeon Dmg", 8, 8),
        new Card(136, "babayaga", "Z0", "Bosses", 1.5, "+{% Money from Monsters", 10, 10),
        new Card(137, "poopBig", "Z1", "Bosses", 1.5, "+{% Total Damage", 5, 5),
        new Card(138, "poopD", "A15", "Bosses", 1, "+{% Fighting AFK gain rate", 1, 1),
        new Card(139, "wolfA", "Z2", "Bosses", 1.5, "+{% Skill AFK gain rate", 2.5, 2.5),
        new Card(140, "wolfB", "Z4", "Bosses", 1.5, "+{% Fighting AFK gain rate", 2.5, 2.5),
        new Card(141, "wolfC", "Z14", "Bosses", 10, "+{ Weapon Power", 3, 3),
        new Card(142, "babaHour", "Z5", "Bosses", 1.5, "+{% Double AFK claim chance", 3, 3),
        new Card(143, "babaMummy", "Z6", "Bosses", 1.5, "+{% Total Drop Rate", 6, 6),
        new Card(144, "Boss2A", "Z3", "Bosses", 1.5, "+{% EXP from monsters", 5, 5),
        new Card(145, "Boss2B", "Z7", "Bosses", 1.5, "+{% Skill EXP", 3.75, 3.75),
        new Card(146, "Boss2C", "Z15", "Bosses", 11, "+{ Star Talent Pts (Passive)", 15, 15),
        new Card(147, "mini3a", "Z12", "Bosses", 5, "+{% Money from Monsters", 12, 12),
        new Card(148, "Boss3A", "Z8", "Bosses", 1.5, "+{% Cog Build Spd (Passive)", 8, 8),
        new Card(149, "Boss3B", "Z9", "Bosses", 1.5, "+{% Shrine Effects", 5, 5),
        new Card(150, "Boss3C", "Z16", "Bosses", 12, "+{% All Stat", 1.5, 1.5),
        new Card(151, "mini4a", "Z13", "Bosses", 5, "+{% Cooking EXP gain", 6, 6),
        new Card(152, "Boss4A", "Z10", "Bosses", 2, "+{% Kitchen Speed (Passive)", 6, 6),
        new Card(153, "Boss4B", "Z11", "Bosses", 2, "+{% All Skill Efficiency", 10, 10),
        new Card(154, "ghost", "Y0", "Event", 2, "+{% Monster EXP While Active", 3, 3),
        new Card(155, "xmasEvent", "Y1", "Event", 1.5, "+{% Total Drop Rate", 3, 3),
        new Card(156, "xmasEvent2", "Y2", "Event", 1.5, "+{% Money from Monsters", 3, 3),
        new Card(157, "slimeR", "Y3", "Event", 2, "+{% Defence from Equipment", 3, 3),
        new Card(158, "loveEvent", "Y4", "Event", 1.5, "+{% Total HP", 5, 5),
        new Card(159, "loveEvent2", "Y5", "Event", 1.5, "+{% Boost Food Effect", 4, 4),
        new Card(160, "sheepB", "Y6", "Event", 3, "+{% MP regen rate", 3, 3),
        new Card(161, "snakeY", "Y7", "Event", 3, "+{ Base LUK", 3, 3),
        new Card(162, "EasterEvent1", "Y8", "Event", 1.5, "+{% Card Drop Chance", 1, 1),
        new Card(163, "EasterEvent2", "Y9", "Event", 1.5, "+{% Critical Damage", 1, 1),
        new Card(164, "shovelY", "Y13", "Event", 4, "+{ Base Defence", 2, 2),
        new Card(165, "crabcakeB", "Y10", "Event", 4, "+{% Total Drop Rate", 3, 3),
        new Card(166, "SummerEvent1", "Y11", "Event", 8, "+{% Fishing Away Gains", 1, 1),
        new Card(167, "SummerEvent2", "Y12", "Event", 8, "+{% Catching EXP", 4, 4),
        new Card(168, "xmasEvent3", "Y14", "Event", 1, "+{% Defence from Equipment", 3, 3),
    ];
}
