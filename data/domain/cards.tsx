...
const cardsInit = () => {
    return [
        ...
        new Card(46, "Void", "D3", "Medium Resources", 10, "+{% Card Drop Chance", 6, 6),
        ...
        new Card(75, "Lustre", "D4", "Hard Resources", 10, "+{ Base LUK", 4, 4),
        ...
        new Card(87, "frogP", "X0", "Dungeons", 1.5, "+{ Base Dungeon MP", 2, 2),
        new Card(88, "frogD", "X1", "Dungeons", 2, "+{% Block Chance", 2, 2),
        new Card(89, "frogY", "X2", "Dungeons", 2, "+{ Base Dungeon Damage", 1.5, 1.5),
        new Card(90, "frogR", "X14", "Dungeons", 2, "+{% Dungeon Card Chance", 6, 6),
        new Card(91, "frogW", "X15", "Dungeons", 3, "+{% Dungeon Credits", 2.5, 2.5),
        new Card(92, "frogGR", "X3", "Dungeons", 1.5, "{% to start with RNG item", 15, 15),
        new Card(93, "frogGR2", "X4", "Dungeons", 1.5, "+{% Dungeon Flurbos", 4, 4),
        new Card(94, "frogGR3", "X5", "Dungeons", 1.5, "+{% Dungeon Credits", 5, 5),
        new Card(95, "target", "X6", "Dungeons", 2, "+{ Base Dungeon HP", 2, 2),
        new Card(96, "rocky", "X7", "Dungeons", 2, "+{% Dungeon Card Chance", 8, 8),
        new Card(97, "steakR", "X9", "Dungeons", 2, "+{% Dungeon Money", 6, 6),
        new Card(98, "totem", "X16", "Dungeons", 2, "+{% RNG item rarity", 10, 10),
        new Card(99, "cactus", "X8", "Dungeons", 2, "+{% Dungeon Boss Dmg", 3, 3),
        new Card(100, "potatoB", "X10", "Dungeons", 5, "+{% Dungeon MP regen", 5, 5),
        new Card(101, "snakeZ", "X11", "Dungeons", 1.5, "+{% Dungeon Drop Rate", 4, 4),
        new Card(102, "snakeZ2", "X12", "Dungeons", 1.5, "+{% Total Dungeon Dmg", 5, 5),
        new Card(103, "snakeZ3", "X13", "Dungeons", 1.5, "+{% Dungeon Flurbos", 5, 5),
        new Card(104, "iceknight", "X17", "Dungeons", 8, "+{% Dungeon MP regen", 8, 8),
        new Card(105, "iceBossZ", "X18", "Dungeons", 2, "+{% Dungeon Card Chance", 15, 15),
        new Card(106, "iceBossZ2", "X19", "Dungeons", 1.5, "+{% Dungeon Credits", 8, 8),
        new Card(107, "iceBossZ3", "X20", "Dungeons", 1.5, "+{% Total Dungeon Dmg", 8, 8),
        new Card(108, "babayaga", "Z0", "Bosses", 1.5, "+{% Money from Monsters", 10, 10),
        new Card(109, "poopBig", "Z1", "Bosses", 1.5, "+{% Total Damage", 5, 5),
        new Card(110, "poopD", "A15", "Bosses", 1, "+{% Fighting AFK gain rate", 1, 1),
        new Card(111, "wolfA", "Z2", "Bosses", 1.5, "+{% Skill AFK gain rate", 2.5, 2.5),
        new Card(112, "wolfB", "Z4", "Bosses", 1.5, "+{% Fighting AFK gain rate", 2.5, 2.5),
        new Card(113, "babaHour", "Z5", "Bosses", 1.5, "+{% Double AFK claim chance", 3, 3),
        new Card(114, "babaMummy", "Z6", "Bosses", 1.5, "+{% Total Drop Rate", 6, 6),
        new Card(115, "Boss2A", "Z3", "Bosses", 1.5, "+{% EXP from monsters", 5, 5),
        new Card(116, "Boss2B", "Z7", "Bosses", 1.5, "+{% Skill EXP", 3.75, 3.75),
        new Card(117, "Boss3A", "Z8", "Bosses", 1.5, "+{% Cog Build Spd (Passive)", 8, 8),
        new Card(118, "Boss3B", "Z9", "Bosses", 1.5, "+{% Shrine Effects", 5, 5),
        new Card(119, "ghost", "Y0", "Event", 2, "+{% Monster EXP While Active", 3, 3),
        new Card(120, "xmasEvent", "Y1", "Event", 1.5, "+{% Total Drop Rate", 3, 3),
        new Card(121, "xmasEvent2", "Y2", "Event", 1.5, "+{% Money from Monsters", 3, 3),
        new Card(122, "slimeR", "Y3", "Event", 2, "+{% Defence from Equipment", 3, 3),
        new Card(123, "loveEvent", "Y4", "Event", 1.5, "+{% Total HP", 5, 5),
        new Card(124, "loveEvent2", "Y5", "Event", 1.5, "+{% Boost Food Effect", 4, 4),
        new Card(125, "sheepB", "Y6", "Event", 3, "+{% MP regen rate", 3, 3),
        new Card(126, "snakeY", "Y7", "Event", 3, "+{ Base LUK", 3, 3),
        new Card(127, "EasterEvent1", "Y8", "Event", 1.5, "+{% Card Drop Chance", 1, 1),
        new Card(128, "EasterEvent2", "Y9", "Event", 1.5, "+{% Critical Damage", 1, 1),
        new Card(129, "shovelY", "Y13", "Event", 4, "+{ Base Defence", 2, 2),
        new Card(130, "crabcakeB", "Y10", "Event", 4, "+{% Total Drop Rate", 3, 3),
        new Card(131, "SummerEvent1", "Y11", "Event", 8, "+{% Fishing Away Gains", 1, 1),
        new Card(132, "SummerEvent2", "Y12", "Event", 8, "+{% Catching EXP", 4, 4),
    ];
}
