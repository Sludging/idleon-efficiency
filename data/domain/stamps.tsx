...
const initStamps = (): Stamp[][] => {
    let combat_stamp = [
        ...
        new Stamp("FILLER", "StampA29", "Combat Stamp", "FILLER", JSON.parse('{"effect": "BaseDef", "function": "add", "x1": 30, "x2": 0, "upgradeInterval": 10, "material": "Copper", "startV": 25, "mCostExp": 6, "startingCost": 50, "cCostExp": 1.3, "i10": 0, "upgradeText": "{} Base Defence", "i12": 0}')),
        new Stamp("FILLER", "StampA30", "Combat Stamp", "FILLER", JSON.parse('{"effect": "BaseDef", "function": "add", "x1": 30, "x2": 0, "upgradeInterval": 10, "material": "Copper", "startV": 25, "mCostExp": 6, "startingCost": 50, "cCostExp": 1.3, "i10": 0, "upgradeText": "{} Base Defence", "i12": 0}')),
        new Stamp("FILLER", "StampA31", "Combat Stamp", "FILLER", JSON.parse('{"effect": "BaseDef", "function": "add", "x1": 30, "x2": 0, "upgradeInterval": 10, "material": "Copper", "startV": 25, "mCostExp": 6, "startingCost": 50, "cCostExp": 1.3, "i10": 0, "upgradeText": "{} Base Defence", "i12": 0}')),
        new Stamp("FILLER", "StampA32", "Combat Stamp", "FILLER", JSON.parse('{"effect": "BaseDef", "function": "add", "x1": 30, "x2": 0, "upgradeInterval": 10, "material": "Copper", "startV": 25, "mCostExp": 6, "startingCost": 50, "cCostExp": 1.3, "i10": 0, "upgradeText": "{} Base Defence", "i12": 0}')),
        ...
        new Stamp("Multikill Stamp", "StampC19", "Misc Stamp", "+{% Base Overkill Rate, for all worlds.", JSON.parse('{"effect": "Overkill", "function": "add", "x1": 1, "x2": 0, "upgradeInterval": 2, "material": "Grasslands1", "startV": 100, "mCostExp": 3, "startingCost": 10000, "cCostExp": 1.3, "i10": 0, "upgradeText": "{}% Base Overkill", "i12": 3}')),
