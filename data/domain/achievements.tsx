...
const initAchieve = () => {
    return [
        ...
        new Achievement(6,"5 'hunned Copper",1,"Have a stack of exactly 500 Copper Ore in your Storage Chest.","*RNG Item"),
        new Achievement(7,"Rookie Player",1,"Reach level 20 on any character.","*STEAM EXCLUSIVE &*8 gems"),
        new Achievement(8,"1.5 Ki'log'grams",1,"Have a stack of exactly 1500 Oak Logs in your Storage Chest.","*RNG Item"),
        new Achievement(9,"Small Savings",1,"Save up 10000 coins.","*STEAM EXCLUSIVE &*8 gems"),
        new Achievement(10,"Copper Quipment",1,"Equip the Copper Helmet and Copper Platebody","*RNG Item"),
        ...
        new Achievement(15,"Wode Together",250,"Defeat 250 Wode Boards with at least 1 other party member","*RNG Item"),
        new Achievement(16,"2 Tons of Iron",1,"Have a stack of exactly 2,000 Iron Ore in your Storage Chest.","*RNG Item"),
        new Achievement(17,"Giga Decimation",1,"Defeat all Giga Frogs before any respawn.","*Encroaching Forest BG &for Title Screen"),
        new Achievement(18,"Shut it Poochy",1,"Defeat Amarok, the stone golem wolf of the Encroaching Forest.","*RNG Item"),
        ...
        new Achievement(21,"Right to Bear Iron",1,"Equip an Iron Helmet, Iron Chestplate, Iron Pants, and one Iron Tool.","*RNG Item"),
        ...
        new Achievement(23,"20 Bundles of Jungle",1,"Have a stack of exactly 20,000 Forest Fibers in your Storage Chest.","*RNG Item"),
        new Achievement(24,"Colosseum Contender",1,"Get a score of 25,000 or more in the Dewdrop Colosseum.","*RNG Item"),
        ...
        new Achievement(32,"Naked and Unafraid",1,"Enter the Sewers with no equipment or weapon, and defeat a sewer poop. Don't want to get your stuff dirty!","*RNG item"),
        new Achievement(33,"House Flipper",1,"Defeat Baba Yaga in under 25 seconds after they spawn in the Birch Enclave","RNG Item"),
        ...
        new Achievement(55,"Anothervil Expansion",20,"Craft the Anvil III expander. More things to craft, hooray!","*STEAM EXCLUSIVE &*30 gems"),
        ...
        new Achievement(62,"FILLERZZZ ACH",20,"-","*STEAM EXCLUSIVE &*30 gems &*Item3"),
        ...
        new Achievement(75,"Hammer Bub",1,"Level up the 'Hammer Hammer' Alchemy bubble to Lv. 10","*RNG item"),
        ...
        new Achievement(79,"Careful, it's Sharp!",1,"Have a stack of exactly 15 Glass Shards in your Storage Chest.","*RNG item"),
        ...
        new Achievement(81,"Vial Noob",1,"Get 3 vials to Lv. 4, which are the green ones","*RNG item"),
        new Achievement(82,"Specializational!",2,"Choose a subclass for two of your characters.","*RNG item"),
        new Achievement(83,"Obols Oh Boy!",1,"Have 10 Silver Obols equipped at once. The Family tab counts here!","2% Arcade balls/hr"),
        new Achievement(84,"Well Learned",1,"Get a lv 92 or higher Star Book from Alchemy! The 1st one, specifically.","*RNG item"),
        ...
        new Achievement(87,"Efaunt Trumped",1,"Defeat Efaunt, the Mummified Elephant God. He will remember you doing this.","*RNG item"),
        ...
        new Achievement(94,"Rat-a-tat-tat",1,"Level up the 'FMJ' Alchemy bubble to Lv. 30","*RNG item"),
        ...
        new Achievement(96,"Vial Connoisseur",1,"Get 6 vials to Lv. 7, which are the pink ones","*RNG item"),
        ...
        new Achievement(101,"Jellyfish Jelly",1,"Have a stack of exactly 6000 Jellyfish in your Storage Chest. I heard their Jelly goes good with burgers btw.","*RNG item"),
        ...
        new Achievement(111,"Bigtime Bloacher",1,"Have a stack of exactly 100,000 Bloaches in your Storage Chest.","*RNG item"),
        ...
        new Achievement(143,"Croakin' Froge",1,"Have a stack of exactly 250 Doge -I mean froge- critters in your Storage Chest.","*RNG item"),
        ...
        new Achievement(147,"Blunder Skull",1,"Get a Copper Skull or higher on every Blunder Hills monster in the Deathnote.","*RNG item"),
        ...
        new Achievement(152,"Good Times Roll",1,"Beat wave 50 in Glublin Gorefest using ONLY Boulder Roller wizards. No freeze, no confetti, just boulder.","*RNG item"),
        ...
        new Achievement(155,"I Sawed...",1,"Upgrade buildings in construction a total of 250 times.","*RNG item"),
        new Achievement(156,"Hairy Ice Comb",3000,"Manually loot 1000 floof poofs, melty cubes, and moustache comb stacks -- ones from AFK claim don't count. You should use Auto for this.","*Frosty Peaks BG &for Title Screen"),
        new Achievement(157,"Giant Slayer",25,"Defeat 5 Giant Mobs of each type Bloque, Mamooth, Snowman, Penguin, & Thermister. Do it in order too, so 5 Bloques first, then 5 mamooths, etc","*Tundra Outback BG &for Title Screen"),
        ...
        new Achievement(169,"Souped Up Salts",1,"Rank up the Redox Combustion refinery chamber to Rank 10.","*RNG item"),
        ...
        new Achievement(176,"Smirky Souls",1,"Have a stack of exactly 250,000 Rooted Souls in your Storage Chest.","*RNG item"),
        ...
        new Achievement(180,"Sepia Vision",1,"Have a stack of exactly 500 Blank Lenses in your Storage Chest. Better complete this before I make it 1,000!","*Crystal Caverns BG &for Title Screen"),
