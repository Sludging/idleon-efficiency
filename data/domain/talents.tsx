...
export const GetTalentArray = (page: string): Talent[] => {
    switch (page) {
        ...
        case "Journeyman": return [
            new Talent(JSON.parse('{"name": "Indiana Attack", "description": "Whip forward, dealing {% dmg and pulling in up to } monsters.", "x1": 50, "x2": 1, "funcX": "bigBase", "y1": 3, "y2": 30, "funcY": "intervalAdd", "lvlUpText": "+{% Dmg & +} Mobs", "skillIndex": 15, "activeData": null}')),
            new Talent(JSON.parse('{"name": "Breakin\' The Bank", "description": "Multiplies value of all coins on ground by {x.", "x1": 0.6, "x2": 100, "funcX": "decayMulti", "y1": 0, "y2": 0, "funcY": "txt", "lvlUpText": "+{X Multi", "skillIndex": 16, "activeData": null}')),
            ...
            new Talent(JSON.parse('{"name": "Gimme Gimme", "description": "Monsters have a {% chance to drop 2x loot for } Minutes", "x1": 80, "x2": 60, "funcX": "decay", "y1": 3, "y2": 20, "funcY": "intervalAdd", "lvlUpText": "+{% Chance & +} Minutes", "skillIndex": 19, "activeData": null}')),
            ...
            new Talent(JSON.parse('{"name": "Its Your Birthday!", "description": "Drops some random reward. Has a {% chance to have no cooldown!", "x1": 35, "x2": 50, "funcX": "decay", "y1": 0, "y2": 0, "funcY": "txt", "lvlUpText": "+{% Chance", "skillIndex": 25, "activeData": null}')),
        ...
        case "Maestro": return [
            new Talent(JSON.parse('{"name": "Coin Toss", "description": "Throws a coin which deals {% Dmg. Damage also increases the more money you have", "x1": 100, "x2": 1, "funcX": "bigBase", "y1": 0, "y2": 0, "funcY": "txt", "lvlUpText": "+{% Dmg", "skillIndex": 30, "activeData": null}')),
            ...
            new Talent(JSON.parse('{"name": "Printer Go Brrr", "description": "Print { Hours of printer samples instantly. }% chance to have no cooldown!", "x1": 1, "x2": 40, "funcX": "intervalAdd", "y1": 95, "y2": 60, "funcY": "decay", "lvlUpText": "{ Hours & +}% No Cd Chance", "skillIndex": 32, "activeData": null}')),
            ...
            new Talent(JSON.parse('{"name": "Maestro Transfusion", "description": "+{% Skill EXP Gain, and -}% Skill Efficiency. Affects all Skills.", "x1": 2.5, "x2": 0, "funcX": "add", "y1": 140, "y2": 100, "funcY": "decay", "lvlUpText": "+{% Exp Gain & -}% Efficiency", "skillIndex": 40, "activeData": null}')),
        ...
        case "Warrior": return [
            new Talent(JSON.parse('{"name": "Power Strike", "description": "Slash forward dealing {% damage to up to 3 monsters", "x1": 130, "x2": 3, "funcX": "bigBase", "y1": 0, "y2": 0, "funcY": "txt", "lvlUpText": "+{% Damage", "skillIndex": 90, "activeData": null}')),
            new Talent(JSON.parse('{"name": "Whirl", "description": "Swing your weapon around you dealing {% damage to up to } monsters", "x1": 60, "x2": 1.5, "funcX": "bigBase", "y1": 4, "y2": 24, "funcY": "intervalAdd", "lvlUpText": "+{% Damage & +} Mobs Hit", "skillIndex": 91, "activeData": null}')),
            ...
            new Talent(JSON.parse('{"name": "Firmly Grasp It", "description": "Temporarily boosts base STR by { for } minutes", "x1": 15, "x2": 1, "funcX": "bigBase", "y1": 2, "y2": 4, "funcY": "intervalAdd", "lvlUpText": "+{ Str & +} Mins", "skillIndex": 94, "activeData": null}')),
            ...
            new Talent(JSON.parse('{"name": "Big Pick", "description": "Swings forward and mines the rock with +{% bonus Mining Efficiency", "x1": 150, "x2": 15, "funcX": "bigBase", "y1": 0, "y2": 0, "funcY": "txt", "lvlUpText": "+{% Efficiency", "skillIndex": 100, "activeData": null}')),
        ...
        case "Barbarian": return [
            new Talent(JSON.parse('{"name": "Bear Swipe", "description": "A big ol\' bear claw swipes up to { monsters in front of you, dealing }% damage", "x1": 3, "x2": 30, "funcX": "intervalAdd", "y1": 108, "y2": 2, "funcY": "bigBase", "lvlUpText": "+{ Mobs & +}% Dmg", "skillIndex": 105, "activeData": null}')),
            new Talent(JSON.parse('{"name": "Axe Hurl", "description": "Throws axe in a downward arc, which deals {% dmg to up to } monsters.", "x1": 200, "x2": 3, "funcX": "bigBase", "y1": 2, "y2": 50, "funcY": "intervalAdd", "lvlUpText": "+{% Dmg & +} Mobs", "skillIndex": 106, "activeData": null}')),
            new Talent(JSON.parse('{"name": "Mocking Shout", "description": "Every 0.5 sec, monsters move toward you and heal for {% HP. Lasts for } seconds", "x1": 1, "x2": 0, "funcX": "add", "y1": 20, "y2": 0.2, "funcY": "bigBase", "lvlUpText": "+1% Heal, +} Sec", "skillIndex": 107, "activeData": null}')),
            new Talent(JSON.parse('{"name": "No Pain No Gain", "description": "Reduces max HP by {%, increases damage by }%. Also, you take double damage.", "x1": 100, "x2": 30, "funcX": "decay", "y1": 100, "y2": 50, "funcY": "decay", "lvlUpText": "-{% Hp & +}% Damage", "skillIndex": 108, "activeData": null}')),
            ...
            new Talent(JSON.parse('{"name": "Worming Undercover", "description": "{% chance", "x1": -1, "x2": -1, "funcX": "9.3", "y1": 0.7, "y2": -1, "funcY": "_", "lvlUpText": "", "skillIndex": 115, "activeData": null}')),
        ...
        case "Squire": return [
            new Talent(JSON.parse('{"name": "Shockwave Slash", "description": "Slash forward, causing a shockwave which deals {% dmg to up to } enemies", "x1": 175, "x2": 2, "funcX": "bigBase", "y1": 3, "y2": 30, "funcY": "intervalAdd", "lvlUpText": "+{% Dmg & +} Mobs Hit", "skillIndex": 120, "activeData": null}')),
            new Talent(JSON.parse('{"name": "Daggerang", "description": "Throw a dagger which comes right back to you, dealing {% Dmg to up to } mobs", "x1": 200, "x2": 1.5, "funcX": "bigBase", "y1": 4, "y2": 30, "funcY": "intervalAdd", "lvlUpText": "+{% Dmg & +} Mobs Hit", "skillIndex": 121, "activeData": null}')),
            new Talent(JSON.parse('{"name": "Bricky Skin", "description": "Block {% of all damage. Also, passively gives +} base DEF at all times, even when not in use!", "x1": 20, "x2": 0.4, "funcX": "bigBase", "y1": 1, "y2": 3, "funcY": "intervalAdd", "lvlUpText": "+{% Block, +} Base Def", "skillIndex": 122, "activeData": null}')),
            ...
            new Talent(JSON.parse('{"name": "Balanced Spirit", "description": "Boosts Accuracy and DEF by +{%, but lowers damage by -}%", "x1": 25, "x2": 50, "funcX": "decay", "y1": 39, "y2": 40, "funcY": "decay", "lvlUpText": "+{% Acc/Def, -}% Dmg", "skillIndex": 124, "activeData": null}')),
            ...
            new Talent(JSON.parse('{"name": "Refinery Throttle", "description": "Automatically trigger { Refinery Cycles. Still costs materials, though.", "x1": 3, "x2": 8, "funcX": "intervalAdd", "y1": 0, "y2": 0, "funcY": "txt", "lvlUpText": "+1 Cycle Every 8 Lvs", "skillIndex": 130, "activeData": null}')),
        ...
        case "Archer": return [
            new Talent(JSON.parse('{"name": "Piercing Arrow", "description": "Shoots an arrow that deals {% damage to up to } monsters", "x1": 110, "x2": 2, "funcX": "bigBase", "y1": 2, "y2": 40, "funcY": "intervalAdd", "lvlUpText": "+{% Damage & +} Mobs Hit", "skillIndex": 270, "activeData": null}')),
            new Talent(JSON.parse('{"name": "Kung Fu Kick", "description": "Pushes back nearby monsters by { pixels while dealing }% damage", "x1": 25, "x2": 1, "funcX": "bigBase", "y1": 60, "y2": 2, "funcY": "bigBase", "lvlUpText": "+{ Pixels & +}% Dmg", "skillIndex": 271, "activeData": null}')),
            ...
            new Talent(JSON.parse('{"name": "Strafe", "description": "Temporarily boosts Movement Speed by {% for } minutes", "x1": 5, "x2": 0.3, "funcX": "bigBase", "y1": 2, "y2": 15, "funcY": "intervalAdd", "lvlUpText": "+{% Speed % +} Mins", "skillIndex": 273, "activeData": null}')),
        ...
        case "Bowman": return [
            new Talent(JSON.parse('{"name": "Homing Arrows", "description": "Fires { arrows into the air, which seek out nearby monsters and deal }% damage", "x1": 2, "x2": 15, "funcX": "intervalAdd", "y1": 27, "y2": 3, "funcY": "bigBase", "lvlUpText": "+{ Arrow & +}% Damage", "skillIndex": 285, "activeData": null}')),
            new Talent(JSON.parse('{"name": "Magic Shortbow", "description": "Magic shortbows fire at your target, and up to { nearby monsters, for }% damage", "x1": 2, "x2": 20, "funcX": "intervalAdd", "y1": 47, "y2": 3, "funcY": "bigBase", "lvlUpText": "+{ Monsters & +}% Dmg", "skillIndex": 286, "activeData": null}')),
            ...
            new Talent(JSON.parse('{"name": "Extendo Rangeo", "description": "Attack range is increased by +{ Pixels, and +}% accuracy, for a few minutes", "x1": 19.5, "x2": 0.5, "funcX": "bigBase", "y1": 40, "y2": 60, "funcY": "decay", "lvlUpText": "+{Px Range & +} Mins", "skillIndex": 288, "activeData": null}')),
        ...
        case "Hunter": return [
            new Talent(JSON.parse('{"name": "360 Noscope", "description": "Deal {% DMG split between all hit monsters. The more mobs hit, the less dmg done", "x1": 225, "x2": 3, "funcX": "bigBase", "y1": 0, "y2": 0, "funcY": "txt", "lvlUpText": "+{% Damage", "skillIndex": 300, "activeData": null}')),
            new Talent(JSON.parse('{"name": "Bear Trap", "description": "Lay down { bear traps that deal }% dmg when a monster triggers it", "x1": 2, "x2": 30, "funcX": "intervalAdd", "y1": 150, "y2": 2, "funcY": "bigBase", "lvlUpText": "+{ Traps & +}% Dmg", "skillIndex": 301, "activeData": null}')),
            new Talent(JSON.parse('{"name": "Uwu Rawrrr", "description": "When mobs die, their respawn time is { seconds faster!", "x1": 55, "x2": 60, "funcX": "decay", "y1": 0, "y2": 0, "funcY": "txt", "lvlUpText": "+{ Seconds Faster", "skillIndex": 302, "activeData": null}')),
            new Talent(JSON.parse('{"name": "Stop Right There", "description": "Immobilizes monsters within a { pixel radius of you for } seconds.", "x1": 150, "x2": 1.5, "funcX": "bigBase", "y1": 4, "y2": 20, "funcY": "intervalAdd", "lvlUpText": "+{ Pixels & +} Sec", "skillIndex": 303, "activeData": null}')),
            ...
            new Talent(JSON.parse('{"name": "Eagle Eye", "description": "Collect & set all traps, but only get {% critters. }% Exp is given to each player.", "x1": 50, "x2": 0.25, "funcX": "bigBase", "y1": 40, "y2": 0.2, "funcY": "bigBase", "lvlUpText": "+{% Critters & +}% Xp", "skillIndex": 310, "activeData": null}')),
        ...
        case "Siege Breaker": return [
            new Talent(JSON.parse('{"name": "Ballista", "description": "Ballista bitch", "x1": 400, "x2": 25, "funcX": "bigBase", "y1": 0, "y2": 0, "funcY": "txt", "lvlUpText": "", "skillIndex": 315, "activeData": null}')),
        ];
        case "Mayheim": return [];
        ...
        case "Mage": return [
            new Talent(JSON.parse('{"name": "Energy Bolt", "description": "Your next basic attack strikes the Targeted Enemy for {% Damage", "x1": 160, "x2": 2, "funcX": "bigBase", "y1": 0, "y2": 0, "funcY": "txt", "lvlUpText": "+{% Damage", "skillIndex": 450, "activeData": null}')),
            new Talent(JSON.parse('{"name": "Mini Fireball", "description": "Shoots a fireball that explodes on impact, dealing {% damage", "x1": 120, "x2": 1, "funcX": "bigBase", "y1": 0, "y2": 0, "funcY": "txt", "lvlUpText": "+{% Damage", "skillIndex": 451, "activeData": null}')),
            ...
            new Talent(JSON.parse('{"name": "Teleport", "description": "Move forward instantly by a distance of { Pixels", "x1": 25, "x2": 1, "funcX": "bigBase", "y1": 0, "y2": 0, "funcY": "txt", "lvlUpText": "+1 Pixel Moved", "skillIndex": 453, "activeData": null}')),
            ...
            new Talent(JSON.parse('{"name": "Log On Logs", "description": "For { Minutes, trees drop }% more Logs than normal", "x1": 2, "x2": 10, "funcX": "intervalAdd", "y1": 14, "y2": 1.86, "funcY": "bigBase", "lvlUpText": "+{ Mins & +}% More Logs", "skillIndex": 460, "activeData": null}')),
        ...
        case "Wizard": return [
            new Talent(JSON.parse('{"name": "Ice Shards", "description": "Your next basic attack deals {% dmg 3 times, and freezes all nearby mobs", "x1": 70, "x2": 1, "funcX": "bigBase", "y1": 0, "y2": 0, "funcY": "txt", "lvlUpText": "+{% Damage", "skillIndex": 465, "activeData": null}')),
            new Talent(JSON.parse('{"name": "Floor Is Lava", "description": "Summon {x2 volcanos which erupt around you, dealing }% dmg", "x1": 1, "x2": 40, "funcX": "intervalAdd", "y1": 120, "y2": 1, "funcY": "bigBase", "lvlUpText": "+{ Volcano & +}% Dmg", "skillIndex": 466, "activeData": null}')),
            new Talent(JSON.parse('{"name": "Tornado", "description": "Summon a tornado, which deals {% dmg and disappears after } seconds", "x1": 20, "x2": 0.3, "funcX": "bigBase", "y1": 4, "y2": 20, "funcY": "intervalAdd", "lvlUpText": "+{% Dmg & +} Sec", "skillIndex": 467, "activeData": null}')),
            new Talent(JSON.parse('{"name": "Speedy Book", "description": "Getting 4@kills in 4@sec activates \'Speedy Book\' boosting attack rate by {% for } sec", "x1": 10, "x2": 0.2, "funcX": "bigBase", "y1": 3, "y2": 15, "funcY": "intervalAdd", "lvlUpText": "+{% Rate & } Sec", "skillIndex": 468, "activeData": null}')),
            new Talent(JSON.parse('{"name": "Mana Is Life", "description": "{% of taken dmg is dealt to MP. Also passively boosts MP regen by +}%", "x1": 25, "x2": 0.35, "funcX": "bigBase", "y1": 15, "y2": 0.35, "funcY": "bigBase", "lvlUpText": "+{% Dmg & }% Mp Regen", "skillIndex": 469, "activeData": null}')),
            ...
            new Talent(JSON.parse('{"name": "Charge Syphon", "description": "Steal charge from all your players, giving you {% of it. +}% Max Charge for 1 Min", "x1": 35, "x2": 0.3, "funcX": "bigBase", "y1": 100, "y2": 10, "funcY": "bigBase", "lvlUpText": "+{% Steal, +}% Temp Max", "skillIndex": 475, "activeData": null}')),
        ...
        case "Shaman": return [
            new Talent(JSON.parse('{"name": "Crazy Concoctions", "description": "Throws 1 of 4 potions, with a potency of {%", "x1": 17, "x2": 3, "funcX": "bigBase", "y1": 0, "y2": 0, "funcY": "txt", "lvlUpText": "+{% Potency", "skillIndex": 480, "activeData": null}')),
            new Talent(JSON.parse('{"name": "Auspicious Aura", "description": "Casts } aura which heals you and damages monsters. The strength of the aura is {%", "x1": 10, "x2": 3, "funcX": "bigBase", "y1": 1, "y2": 35, "funcY": "intervalAdd", "lvlUpText": "+{% Strength & +} Auras", "skillIndex": 481, "activeData": null}')),
            new Talent(JSON.parse('{"name": "Sizzling Skull", "description": "Fire a skull which bounces around dealing {% dmg to up to } monsters", "x1": 125, "x2": 1, "funcX": "bigBase", "y1": 3, "y2": 20, "funcY": "intervalAdd", "lvlUpText": "+{% Dmg & +} More Mobs", "skillIndex": 482, "activeData": null}')),
            ...
            new Talent(JSON.parse('{"name": "Cranium Cooking", "description": "Killing a monster gives { seconds of instant alchemy progress. Lasts for } seconds", "x1": 40, "x2": 100, "funcX": "decay", "y1": 10, "y2": 2, "funcY": "intervalAdd", "lvlUpText": "+{ Progress & +} Time", "skillIndex": 490, "activeData": null}')),
        ...
        case "Special Talent 1": return [
            ...
            new Talent(JSON.parse('{"name": "Roll Da Dice", "description": "Rolls a { sided dice. If it lands on a 1, you win a special Trophy!", "x1": 10000, "x2": 25, "funcX": "reduce", "y1": 0, "y2": 0, "funcY": "txt", "lvlUpText": "Dice Only Has { Sides", "skillIndex": 623, "activeData": null}')),
            ...
            new Talent(JSON.parse('{"name": "Exp Converter", "description": "{% of EXP earned in chosen Skill is turned to Class EXP. Assign to Attack to choose.", "x1": 150, "x2": 200, "funcX": "decay", "y1": 0, "y2": 0, "funcY": "txt", "lvlUpText": "+{% Exp Converted", "skillIndex": 626, "activeData": null}')),
        ...
        case "Special Talent 2": return [
            ...
            new Talent(JSON.parse('{"name": "Telekinetic Storage", "description": "Deposits your items to storage, and destroys items on ground. PASSIVE: +{% Carry Cap", "x1": 30, "x2": 60, "funcX": "decay", "y1": 0, "y2": 0, "funcY": "txt", "lvlUpText": "+{% Carry Cap", "skillIndex": 634, "activeData": null}')),
            new Talent(JSON.parse('{"name": "Printer Sampling", "description": "Cast to sample {% of your current AFK gains rate, which is used by the 3d Printer.", "x1": 10, "x2": 0.075, "funcX": "bigBase", "y1": 0, "y2": 0, "funcY": "txt", "lvlUpText": "+{% Afk Gains Sampled", "skillIndex": 635, "activeData": null}')),
            ...
            new Talent(JSON.parse('{"name": "Shrine Architect", "description": "Cast this talent to place shrines. You also charge them +{% faster", "x1": 50, "x2": 50, "funcX": "decay", "y1": 0, "y2": 0, "funcY": "txt", "lvlUpText": "+{% Charge Rate", "skillIndex": 639, "activeData": null}')),
