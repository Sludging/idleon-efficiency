import { getAllItems, filteredLootyItems } from './items'
...
export default function parseLooty(lootedInfo: string[]) {
    ...
    toReturn.missing = toReturn.obtainable.filter(([rawName, _]) => toReturn.obtained.find(([obtainedRaw, _]) => obtainedRaw == rawName) == undefined);
