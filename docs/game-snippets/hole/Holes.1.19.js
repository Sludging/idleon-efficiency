 ...
 * Function: _customBlock_Holes (from scripts.ActorEvents_579)
...
function (e, t, i) {
                            ...
                            if ("PreventUI" == e)
                                return 216 == a.engine.getGameAttribute("CurrentMap") &&
                                    (0 != n.__cast(a.engine.getGameAttribute("PixelHelperActor")[25].behaviors.getBehavior("ActorEvents_670"), Ga)._GenINFO[79] ||
                                        0 != n.__cast(a.engine.getGameAttribute("PixelHelperActor")[25].behaviors.getBehavior("ActorEvents_670"), Ga)._GenINFO[139] ||
                            ...
                            if ("OpalsOwnedToInvest" == e) return n.__cast(a.engine.getGameAttribute("PixelHelperActor")[25].behaviors.getBehavior("ActorEvents_670"), Ga)._GenINFO[69];
                            if ("createOpal" == e)
                                return (
                                    (n.__cast(a.engine.getGameAttribute("PixelHelperActor")[25].behaviors.getBehavior("ActorEvents_670"), Ga)._TRIGGEREDtext = "d"),
                            ...
                            if ("MeasurementBaseBonus" == e)
                                return -1 != ("" + h.string(a.engine.getGameAttribute("CustomLists").h.HolesInfo[55][0 | t])).indexOf("TOT")
                                    ? (1 + m._customBlock_Holes("CosmoBonusQTY", 1, 3) / 100) *
                                          ((c.asNumber(z.replace("" + h.string(a.engine.getGameAttribute("CustomLists").h.HolesInfo[55][0 | t]), "TOT", "")) * c.asNumber(a.engine.getGameAttribute("Holes")[22][0 | t])) /
                            ...
                            if ("Bravery_MaxDMG" == e)
                                return (
                                    ...
                                    (1 + (m._customBlock_Holes("B_UPG", 40, 10) * c.asNumber(n.__cast(a.engine.getGameAttribute("PixelHelperActor")[25].behaviors.getBehavior("ActorEvents_670"), Ga)._GenINFO[89])) / 100) *
                                    (1 + (10 * c.asNumber(n.__cast(a.engine.getGameAttribute("PixelHelperActor")[25].behaviors.getBehavior("ActorEvents_670"), Ga)._GenINFO[127])) / 100)
                                );
                            ...
                            if ("Bravery_MonsterHP" == e)
                                return (
                                    (10 + 15 * c.asNumber(n.__cast(a.engine.getGameAttribute("PixelHelperActor")[25].behaviors.getBehavior("ActorEvents_670"), Ga)._GenINFO[76])) *
                                    Math.pow(1.3, c.asNumber(n.__cast(a.engine.getGameAttribute("PixelHelperActor")[25].behaviors.getBehavior("ActorEvents_670"), Ga)._GenINFO[76]))
                                );
                            ...
                            if ("HarpStringAllBonus" == e)
                                return (
                                    ...
                                    (m._customBlock_Holes("B_UPG", 39, 15) +
                                        (m._customBlock_Holes("B_UPG", 37, 20) * c.asNumber(n.__cast(a.engine.getGameAttribute("PixelHelperActor")[25].behaviors.getBehavior("ActorEvents_670"), Ga)._GenINFO[128]) +
                                            m._customBlock_Holes("B_UPG", 38, 30) * c.asNumber(n.__cast(a.engine.getGameAttribute("PixelHelperActor")[25].behaviors.getBehavior("ActorEvents_670"), Ga)._GenINFO[129]))) /
                                        100
                                );
                            if ("HarpNoteProduced" == e)
                                return (
                                    ((c.asNumber(n.__cast(a.engine.getGameAttribute("PixelHelperActor")[25].behaviors.getBehavior("ActorEvents_670"), Ga)._GenINFO[112]) / 100) *
                                    ...
                                    m._customBlock_Holes("HarpStringAllBonus", 0, 0) *
                                        (1 -
                                            Math.pow(
                                                ...
                                                Math.max(1, c.asNumber(n.__cast(a.engine.getGameAttribute("PixelHelperActor")[25].behaviors.getBehavior("ActorEvents_670"), Ga)._GenINFO[112]) / 100)
                                            ))
                                );
