...
function (e, t, i) {
                            ...
                            if ("W_attempts" == e)
                                return 1 == n.__cast(a.engine.getGameAttribute("PixelHelperActor")[25].behaviors.getBehavior("ActorEvents_670"), Ga)._GenINFO[210]
                                    ? 30
                                    : Math.round(
                                          5 +
                            ...
                            if ("W_timePerMatch" == e) return 1 == n.__cast(a.engine.getGameAttribute("PixelHelperActor")[25].behaviors.getBehavior("ActorEvents_670"), Ga)._GenINFO[210] ? 1e3 : 12.6;
                            if ("W_instamatches" == e)
                                return 1 == n.__cast(a.engine.getGameAttribute("PixelHelperActor")[25].behaviors.getBehavior("ActorEvents_670"), Ga)._GenINFO[210]
                                    ? 0
                                        ...
                                        for (r = e++, a.engine.getGameAttribute("DNSM").h.FountBonTdn = r, s = 0; 20 > s; )
                                            ((_ = s++),
                                                a.engine
                                                    ...
                                                    .h.FountBonT[
                                                        0 | c.asNumber(a.engine.getGameAttribute("DNSM").h.FountBonTdn)
                                                    ].push(m._customBlock_Holes2("Fountain_MarbleBon", c.asNumber(a.engine.getGameAttribute("DNSM").h.FountBonTdn), _) * c.asNumber(a.engine.getGameAttribute("Holes")[31][0 | c.asNumber(a.engine.getGameAttribute("DNSM").h.FountBonTdn)][_]) * c.asNumber(a.engine.getGameAttribute("CustomLists").h.HoleFountUPG[0 | c.asNumber(a.engine.getGameAttribute("DNSM").h.FountBonTdn)][_][6])));
                            ...
                            if ("Fount_GenerateCoin" == e) {
                                for (
                                    ...
                                    ((r = e++),
                                        -1 != ("" + h.string(a.engine.getGameAttribute("Holes")[11][83])).indexOf("" + h.string(a.engine.getGameAttribute("Number2Letter")[r])) && ba.remove(a.engine.getGameAttribute("DNSM").h.FountDL1, r));
                                return (
