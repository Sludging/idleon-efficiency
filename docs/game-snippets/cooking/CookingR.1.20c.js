 ...
 * Game version: 1.20c ("Royal_Guardian")
 * Captured: 2026-09-01 via game-debug-tool (findFunction + toString)
 * Case reference: #354
 */
function (e, t, i) {
                            if ("PossibleRecipes" == e)
                                return p._customBlock_CookingR("PossibleRecipes2", c.asNumber(n.__cast(a.engine.getGameAttribute("PixelHelperActor")[21].behaviors.getBehavior("ActorEvents_510"), dc)._GenINFO[62]), 0);
                            if ("PossibleRecipes2" == e) {
                                var s = a.engine.getGameAttribute("DNSM"),
                                    r = [];
                                if (((s.h.CookinPossibleRecps = r), -1 != t)) {
                                    for (e = 0; 4 > e;)
                                        ((i = e++),
                                            (s = a.engine.getGameAttribute("DNSM")),
                                            (r = a.engine.getGameAttribute("Cooking")[0 | t][2 + i]),
                                            (s.h.CookinPossibleRecpsDN1 = r),
                                    ...
                                    for (a.engine.getGameAttribute("DNSM").h.CookinPossibleRecpsDN1 = 0, e = a.engine.getGameAttribute("DNSM").h.CookinPossibleRecpsDN3 = 0; 4 > e;)
                                        ((i = e++),
                                            (s = a.engine.getGameAttribute("DNSM")),
                                            (r = c.asNumber(a.engine.getGameAttribute("DNSM").h.CookinPossibleRecpsDN1) + Math.max(0, c.asNumber(a.engine.getGameAttribute("Cooking")[0 | t][2 + i]))),
                                            (s.h.CookinPossibleRecpsDN1 = r),
                                    ...
                                    if (
                                        (71 > c.asNumber(a.engine.getGameAttribute("DNSM").h.CookinPossibleRecpsDN1)
                                            ? ((s = a.engine.getGameAttribute("DNSM")), (r = Math.min(55, c.asNumber(a.engine.getGameAttribute("DNSM").h.CookinPossibleRecpsDN1))))
                                            : 87 > c.asNumber(a.engine.getGameAttribute("DNSM").h.CookinPossibleRecpsDN1)
                                              ? ((s = a.engine.getGameAttribute("DNSM")), (r = Math.min(65, Math.round(c.asNumber(a.engine.getGameAttribute("DNSM").h.CookinPossibleRecpsDN1) - 14))))
                                              : ((s = a.engine.getGameAttribute("DNSM")), (r = Math.round(c.asNumber(a.engine.getGameAttribute("DNSM").h.CookinPossibleRecpsDN1) - 22))),
                                        (s.h.CookinPossibleRecpsDN1 = r),
                                        0.5 < c.asNumber(a.engine.getGameAttribute("DNSM").h.CookinPossibleRecpsDN1))
                                    )
                                        for (
                                            s = a.engine.getGameAttribute("DNSM"),
                                                r = Math.min(c.asNumber(a.engine.getGameAttribute("DNSM").h.CookinPossibleRecpsDN3), 3),
                                                s.h.CookinPossibleRecpsDN2 = r,
                                                e = 0,
                                ...
                                for (r = [], (s = a.engine.getGameAttribute("DNSM")).h.CookinPossibleRecps2 = r, e = 0, t = a.engine.getGameAttribute("DNSM").h.CookinPossibleRecps.length; e < t;) {
                                    for (e++, a.engine.getGameAttribute("DNSM").h.CookinPossibleRecpsDN1 = 99999, i = 0, s = n.__cast(a.engine.getGameAttribute("DNSM").h.CookinPossibleRecps, Array); i < s.length;)
                                        ((r = s[i]),
                                            ++i,
                                            c.asNumber(r) < c.asNumber(a.engine.getGameAttribute("DNSM").h.CookinPossibleRecpsDN1) &&
                                                !D.contains(a.engine.getGameAttribute("DNSM").h.CookinPossibleRecps2, r) &&
                                                (a.engine.getGameAttribute("DNSM").h.CookinPossibleRecpsDN1 = r));
                                    a.engine.getGameAttribute("DNSM").h.CookinPossibleRecps2.push(a.engine.getGameAttribute("DNSM").h.CookinPossibleRecpsDN1);
                                }
                                return ((n.__cast(a.engine.getGameAttribute("PixelHelperActor")[21].behaviors.getBehavior("ActorEvents_510"), dc)._GenINFO[69] = a.engine.getGameAttribute("DNSM").h.CookinPossibleRecps2), 0);
                            }
                            ...
                            if ("CookingSPEED" == e)
                                return (
                                    ...
                                    10 *
                                        ...
                                        (1 + m._customBlock_Summoning("EventShopOwned", 53, 0)) *
                                        ...
                                        (1 + (q._customBlock_MealBonus("zMealFarm") * Math.ceil((c.asNumber(a.engine.getGameAttribute("Lv0")[16]) + 1) / 50)) / 100) *
                                        ...
                                        (1 + q._customBlock_MealBonus("Mcook") / 100) *
                                        ...
                                        (1 +
                                            (q._customBlock_MealBonus("KitchenEff") *
                                                Math.floor(
                            ...
                            if ("CookingFIRE" == e)
                                return (
                                    ...
                                    5 *
                                        ...
                                        (1 + q._customBlock_MealBonus("Rcook") / 100) *
                                    ...
                                    1 +
                                        (1 /
                                            ((1 + (c.asNumber(a.engine.getGameAttribute("DNSM").h.AlchVials.h.Kcosts) + p._customBlock_Labb("SigilBonus", "Blank", 18, 0)) / 100) *
                                                ...
                                                (1 + q._customBlock_MealBonus("KitchC") / 100) *
                            ...
                            if ("CookingFireREQ" == e)
                                return (
                                    (s = a.engine.getGameAttribute("DNSM")),
                                    (r = p._customBlock_CookingR("PossibleRecipes2", t, 0)),
                                    (s.h.CookinPossibleRecps = r),
                                    (s = a.engine.getGameAttribute("DNSM")),
                                    (r = a.engine.getGameAttribute("DNSM").h.CookinPossibleRecps2),
                                    (s.h.CookinPossibleRecps = r),
                                    (s = a.engine.getGameAttribute("DNSM")),
                                    (r = a.engine.getGameAttribute("DNSM").h.CookinPossibleRecps[a.engine.getGameAttribute("DNSM").h.CookinPossibleRecps.length - 1]),
                                    (s.h.CookinPossibleRecpsDN1 = r),
                                    2 *
                            ...
                            if ("CookingFireREQlv" == e) {
                                for (
                                    s = a.engine.getGameAttribute("DNSM"), r = p._customBlock_CookingR("CookingFireREQ", t, 0), s.h.CookinPossibleRecpsDN1 = r, e = a.engine.getGameAttribute("DNSM").h.CookinPossibleRecpsDN2 = 0;
                                    ...
                                    ((s = a.engine.getGameAttribute("DNSM")),
                                        (r = c.asNumber(a.engine.getGameAttribute("DNSM").h.CookinPossibleRecpsDN1) * p._customBlock_CookingR("CookingFireREQlvMULTI", 0, 0)),
                                        (s.h.CookinPossibleRecpsDN1 = r),
                            ...
                            return "CookingFireREQlvMULTI" == e
                                ...
                                : "CookingMenuMealCosts" == e
                                  ...
                                  : "CookingNewRecipeOdds" == e
                                    ? 0 >= c.asNumber(a.engine.getGameAttribute("Meals")[0][0 | c.asNumber(n.__cast(a.engine.getGameAttribute("PixelHelperActor")[21].behaviors.getBehavior("ActorEvents_510"), dc)._GenINFO[69][0 | t])])
